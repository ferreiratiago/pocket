...
import (
	...
	"github.com/pokt-network/pocket/p2p/errors"
...
var (
	...
	ErrModule = errors.NewErrFactory("LibP2P module error")
	// ErrCloseStream wraps errors which occur when attempting to close a peer stream.
	ErrCloseStream = errors.NewErrFactory("an error occurred while closing peer stream")
